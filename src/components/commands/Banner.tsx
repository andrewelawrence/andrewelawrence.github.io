...
const Banner: React.FC = () => {
 ...
 "Y8888  888  888  "Y888  "Y88P"  888  888"
        ...
        <div>
          This project's source code can be found in it's{" "}
          <Link href="https://github.com/andrewelawrence/andrewelawrence.github.io">
            GitHub repo
          </Link>
          .
        </div>
        <div>
          Type `<Cmd>help</Cmd>` for a list of available commands.
        </div>
      </div>
    </HeroContainer>
  );
