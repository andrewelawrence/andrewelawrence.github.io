...
export const commands: Command = [
  ...
  { cmd: "banner", desc: "Display the welcome banner", tab: 6},
  { cmd: "blog", desc: "Read my blog", tab: 9},
...
//   { cmd: "socials", desc: "check out my social accounts", tab: 6 },
  { cmd: "themes", desc: "Check out the available themes", tab: 7},
//   { cmd: "whoami", desc: "About You", tab: 7 },
];
